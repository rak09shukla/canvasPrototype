...
changeHandlerRadio=(e)=>{
  ...
  render() {
    ...
    if(this.props.profile.edit){
      ...
      <div><span>FirstName : </span><input value={this.state.firstName} required type="text" onChange={(e)=>{this.changeHandlerCommon("firstName",e)}}></input></div>
      <div><span>LastName : </span><input value={this.state.lastName} required type="text" onChange={(e)=>{this.changeHandlerCommon("lastName",e)}}></input></div>
...
)(connect(mapStatetoProps,mapActionToProps)(Profile));
