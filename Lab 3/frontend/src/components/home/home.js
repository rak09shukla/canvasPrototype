...
const SortableItem = SortableElement(({data,index}) => {
 ...
 let style={backgroundColor:colors[index],
...
onSortEnd = ({oldIndex, newIndex}) => {
  ...
  // }));
  var items=this.state.courseList;
    ...
    render(){
        ...
        return(
            <div className="home-dashboard">
               ...
               <h2>Dashboard</h2>
               <div>
                  <SortableList axis={"xy"} pressDelay={100} items={this.state.courseList} onSortEnd={this.onSortEnd} />
